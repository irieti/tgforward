...
group_filters = {
    (-4596601978, -4566457371): ["keyword", "keyword"],
}

# Stop-words for source groups
group_stopwords = {
    (-4596601978): ["stopword", "stopword"],
}

# Dynamic target group mapping
group_config = {
    (-4596601978, -4566457371): [
        322641207
    ],  # Source group to target group mapping group
}
...
async def process_message():
    while True:
        ...
        logging.debug(f"Processing message ID {message_id} from source {source_id}.")
